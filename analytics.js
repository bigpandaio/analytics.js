...
Mixpanel.prototype.initialize = function () {
  ...
  this.load(options.mixpanelUrlOverride);
};
...
Mixpanel.prototype.load = function (mixpanelUrlOverride, callback) {
  load(mixpanelUrlOverride || '//cdn.mxpnl.com/libs/mixpanel-2.2.min.js', callback);
};
